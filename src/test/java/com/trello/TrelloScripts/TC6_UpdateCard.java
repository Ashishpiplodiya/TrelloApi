 ...
 */
@Epic("Update")
public class TC6_UpdateCard extends BaseTest {

	@Story("Update a Card")
	@Description("Update Card in Trello Board")
	...
	public void updateCard(String SlNo,String methodName,String endPointUrl,String fileName,String header,String methodAction,String queryParam,String pathParam,String boardName , String listName , String cardName,String expectedStatusCode) throws InterruptedException
	{
		...
		/*Validating Schema*/
		Util.schemaValidation(response, prop.getProperty("updateCard"));
	
		/*Pass Message*/
		Util.logMessage("Card Updated Successfully");
	}
