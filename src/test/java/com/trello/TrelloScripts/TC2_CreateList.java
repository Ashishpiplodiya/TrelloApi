...
public class TC2_CreateList extends BaseTest{
								...
								String listName , String cardName,String expectedStatusCode) throws InterruptedException
		{
			...
			Response response = Util.executeApi(methodName,endPointUrl,fileName,header,methodAction,queryParam,pathParam,boardName,listName,cardName,prop.getProperty("listId"));
			...
			/*Pass Message*/
			Util.logMessage("List Created Successfully");
		}
